...
\begin{tabular}{|l|l|l|}
	...
	\begin{tabular}[c]{@{}l@{}}
		$\underline{I}_2^{\prime} = 0$ \\ 
		$\underline{I}_{10} = \underline{I}_{\mu} + \underline{I}_{Fe}$ \\ 
		$\underline{U}_{1} = R_{1} \cdot \underline{I}_{1} + j \omega L_{1\sigma} \cdot \underline{I}_{1} + j \omega L_{m}\underline{I}_{\mu}$ \\ 
		$0 = -j \omega L_{m}\underline{I}_{\mu} + \underline{U}_{2}^{\prime}$
	\end{tabular} & 
	\begin{tabular}[c]{@{}l@{}}
		$\underline{I}_{1} = \underline{I}_{\mu} + \underline{I}_{Fe} + \underline{I}_{2}^{\prime}$ \\ 
		$\underline{U}_{1} = R_{1} \cdot \underline{I}_{1} + j \omega L_{1\sigma} \cdot \underline{I}_{1} + j \omega L_{m}\underline{I}_{\mu}$ \\ 
		$0 = R_{2}^{\prime} \cdot \underline{I}_{2}^{\prime} + j \omega L_{2\sigma}^{\prime} \cdot \underline{I}_{2}^{\prime} - j \omega L_{m}\underline{I}_{\mu} + \underline{U}_{2}^{\prime}$ \\ 
		$\underline{U}_{m} = j \omega L_{m}\underline{I}_{\mu}$
	\end{tabular} & 
	\begin{tabular}[c]{@{}l@{}}
		$\underline{I}_{1} = \underline{I}_{\mu} + \underline{I}_{Fe} + \underline{I}_{2}^{\prime}$ \\ 
		$\underline{U}_{1} = R_{1} \cdot \underline{I}_{1} + j \omega L_{1\sigma} \cdot \underline{I}_{1} + j \omega L_{m}\underline{I}_{\mu}$ \\ 
		$0 = R_{2}^{\prime} \cdot \underline{I}_{2}^{\prime} + j \omega L_{2\sigma}^{\prime} \cdot \underline{I}_{2}^{\prime} - j \omega L_{m}\underline{I}_{\mu}$ \\ 
		$\underline{U}_2^{\prime} = 0$ \\ 
		$\underline{U}_{m} = j \omega L_{m}\underline{I}_{\mu}$
	\end{tabular} \\ & & \\ \hline
		\includegraphics[height=0.07\textwidth]{bilder/Unbelastet_RostBau.png} 
		\rule{0pt}{42pt} & 
		\includegraphics[height=0.07\textwidth]{bilder/Belastet_RostBau.png} 
		\rule{0pt}{42pt} & 
		\includegraphics[height=0.07\textwidth]{bilder/Kurzschluss_RostBau.png}
		\rule{0pt}{42pt} \\ \hline
\end{tabular}
